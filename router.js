...
router.get("/project-menu/", authorizeUser, (req, res) =>
  res.render("project-menu", { isAuthorized: res.locals.isAuthorized })
);

// router.post("/prepare-translation", authorizeUser, async (req, res) => {
// get strings from crowdin
// call lyre api
